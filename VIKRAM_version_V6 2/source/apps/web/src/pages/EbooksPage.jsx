...
const EbooksPage = () => {
  ...
  const getImageUrl = (p) => {
    return p.coverImageUrl || p.image || 'https://images.unsplash.com/photo-1547817705-54f36887b36a?auto=format&fit=crop&w=600&q=80';
  };
  ...
  return (
    <>
      ...
      <div className="bg-black min-h-screen text-white pt-32 pb-24 font-sans relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#FFD700]/5 blur-[120px] rounded-full pointer-events-none -translate-y-1/2 translate-x-1/2" />
        ...
        <div className="container mx-auto px-6 max-w-7xl relative z-10">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-6">
            <h1 className="text-4xl md:text-6xl font-bold mb-4 tracking-tighter text-white">Elite Ebooks</h1>
            ...
            <p className="text-base text-white/50 max-w-xl mx-auto font-light">
              Architected systems for mental clarity and unshakeable discipline.
            </p>
          </motion.div>
          ...
          {loading ? (
            ...
            <div className="text-center py-32 text-white/30 glass-card rounded-2xl max-w-lg mx-auto border-white/5">
              <p className="text-xl mb-2 font-medium">No ebooks available yet.</p>
              <p className="text-xs uppercase tracking-widest opacity-60">Architecting new content...</p>
            </div>
          ) : (
