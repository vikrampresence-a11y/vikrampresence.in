...
import { savePurchase } from '@/lib/purchaseStore';
...
const DirectCheckoutButton = ({ productName, pricePaise, driveLink }) => {
    ...
    const triggerDelivery = async (paymentId) => {
        try {
            const endpoint = isShopDomain ? PHP_API : `${API_URL}/deliver`;
    ...
    const handleClick = () => {
        ...
        const rzp = new window.Razorpay({
            ...
            handler: async (response) => {
                ...
                // Save purchase to localStorage for My Products page
                savePurchase({
                    productName,
                    googleDriveLink: driveLink,
                    pricePaise,
                ...
                navigate('/thank-you', {
                    state: {
                        ...
                        smsSent: deliveryResult.smsSent,
                    },
                });
            },
